...
function createDisplay() {
      ...
      var $keyList = $('<div id="key-list"><ul><li>Risk:</li><li class="key-item"><div class="alert green"></div><p>&nbspLow</p></li><li class="key-item"><div class="alert yellow"></div><p>&nbspMedium</p></li><li class="key-item"><div class="alert red"></div><p>&nbspHigh</p></li><li class="key-item"><div class="alert blue">i</div><p>&nbspAttention</p></li></ul>' );
      ...
      if (mpnData.encryption.device === yesDefault) {
          ...
          $encryptionLocal.append('<div class="answer"><div class="alert blue">i</div><h4>Will we encrypt your data within your device? Answer is N/A</h4></div>');
      }
      ...
      if (mpnData.encryption.server === yesDefault) {
          ...
          $encryptionServer.append('<div class="answer"><div class="alert blue">i</div><h4>Will we encrypt your data when stored on our company servers or on the cloud? Answer is N/A</h4></div>');
      }
      ...
      if (mpnData.encryption.transmit === yesDefault) {
          ...
          $encryptionTransmit.append('<div class="answer"><div class="alert blue">i</div><h4>Will we encrypt your data while it is transmitted? Answer is N/A</h4></div>');
      }
      ...
      $userQuestion.append('<div class="answer"><div class="alert blue">i</div><h4>What can you do with your data?</h4></div>');
      ...
      $policyQuestion.append('<div class="answer"><div class="alert blue">i</div><h4>How will we notify you if our privacy policy changes?</h4></div>');
      ...
      $breachQuestion.append('<div class="answer"><div class="alert blue">i</div><h4>How will we notify you and protect your data in case of an improper disclosure?</h4></div>');
