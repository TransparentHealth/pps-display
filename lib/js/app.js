...
function createDisplay() {
      ...
      var $keyList = $('<div id="key-list"><ul><li class="key-item first"><p>Risk:</p></li><li class="key-item"><div class="alert green"></div><p>&nbspLow</p></li><li class="key-item"><div class="alert yellow"></div><p>&nbspMedium</p></li><li class="key-item"><div class="alert red"></div><p>&nbspHigh</p></li><li class="key-item"><div class="alert blue">i</div><p>&nbspAttention</p></li></ul>' );
